...
let datas = [
    { time: 0, pumpB: 20, pumpA: 80, flowRate: 10 },
    { time: 2, pumpB: 20, pumpA: 80, flowRate: 10 },
    { time: 5, pumpB: 50, pumpA: 50, flowRate: 10 },
    { time: 10, pumpB: 50, pumpA: 50, flowRate: 10 },
    { time: 15, pumpB: 80, pumpA: 20, flowRate: 10 },
    { time: 20, pumpB: 80, pumpA: 20, flowRate: 10 },
];
...
const DynamicLine = (props) => {
    ...
    useEffect(() => {
        ...
        const data = transformAndSortData(datas);
