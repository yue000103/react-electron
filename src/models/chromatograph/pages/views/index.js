                              ...
                              <Row style={{marginTop: '30px'}}>
                                  ...
                                  <Col span={15}>
                                      <div style={{ 
                                          ...
                                          borderRadius: '6px',
                                          backgroundColor: 'rgb(168, 166, 102)',
                                          display: 'flex', 
                                          alignItems: 'center', 
                                          ...
                                          <span style={{ fontSize: '14px' ,color: 'rgb(255, 252, 252)'}}>自动梯度</span>
                                          <Switch 
                                              checked={autoGradient} 
                                              onChange={(checked) => {
                                                  setAutoGradient(checked);
                                                  autoGradientLet = true
                                                  console.log('0705   autoGradientLet',)
                                                  if (checked) {
                    ...
                    <Row gutter={8}>
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入起始比例" }]}
                            >
                        ...
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入终止比例" }]}
                            >
                                <InputNumber min={0} max={100} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                name="n1_volumes"
                                tooltip="首段恒流持续的柱体积数"
                                rules={[{ required: true, message: "请输入柱体积倍数" }]}
                            >
                        ...
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入梯度速率" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入峰检测阈值" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                name="column_volume"
                                tooltip="柱子实际总内体积(mL)"
                                rules={[{ required: true, message: "请输入柱体积" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入平滑窗口宽度" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入平滑多项式阶数" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                tooltip="基线校正参考窗口点数"
                                rules={[{ required: true, message: "请输入基线窗口宽度" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "请输入灵敏度系数" }]}
                            >
                                <InputNumber min={0} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
